(function () {
    ...
    function ServiceInvoiceController($scope, $http, $location, $filter, $timeout, $rootScope) {
        ...
        $http({
            method: 'GET',
            url: 'http://166.62.84.37/PetzCareWS/ServiceInvoice.svc/GetAllServiceInvoiceLists',
            headers: {
                "Content-Type": 'application/json',
            }
        }).success(function (response) {
        ...
        $scope.ConfrmEmail = function () {
            ...
            $http({
                ...
                url: ' http://166.62.84.37/PetzCareWS/ServiceInvoice.svc/ServiceInvoiceReportSendPDFEmail',
                headers: {
                    "Content-Type": 'application/json',
                }
            }).success(function (response) {
        ...
        "appointment_name":$scope.selectedaptinvoice.appointment_name
            ...
            if (!$scope.invoiceForm.$invalid) {
                ...
                $http({
                    ...
                    url: 'http://166.62.84.37/PetzCareWS/ServiceInvoice.svc/AddServiceInvoice',
                    headers: {
                        "Content-Type": 'application/json',
                    }
                }).success(function (response) {
