(function () {
    ...
    function ManageServicesController($scope, $http, $rootScope, $filter, $timeout) {
        ...
        setTimeout(function () {
            $http({
                method: 'GET',
                url: 'http://166.62.84.37/PetzCareWS/PetServices.svc/GetAllServices',
                headers: {
        ...
        $scope.Seradd = function () {
            ...
            var timestamp = Number(($scope.effdate));
           ...
           // console.log($scope.serviceTypes.ld_name);
            ...
            if (!$scope.NewServiceForm.$invalid) {
                ...
                $http({
                    method: 'POST',
                    data: $scope.data,
                    url: 'http://166.62.84.37/PetzCareWS/PetServices.svc/AddPetService',
                    headers: {
                        "Content-Type": 'application/json',
                    }
        ...
        $scope.serviceId = function (servcID) {
            ...
            $http({
                ...
                url: 'http://166.62.84.37/PetzCareWS/PetServices.svc/GetServiceById',
                headers: {
                    "Content-Type": 'application/json',
                }
            }).success(function (response) {
        ...
        $scope.UpdateGroom = function () {
            $scope.submitted = true;
            var timestamp = Number(($scope.effUpdatdate));
            ...
            if (!$scope.UpdateServiceForm.$invalid) {
                $http({
                    method: 'POST',
                    data: $scope.data,
                    url: 'http://166.62.84.37/PetzCareWS/PetServices.svc/UpdatePetService',
                    headers: {
                        "Content-Type": 'application/json',
                    }
                }).success(function (response) {
        ...
        $scope.servicesdelete = function (servcid, indexvalue) {
            ...
            if (Delete == true) {
            $http.post("http://166.62.84.37/PetzCareWS/PetServices.svc/DeletePetService", $scope.DeltData).success(function (response) {
                if (response == true) {
                    $scope.ServiceLists = [];
                    $scope.ServiceBoarding = [];
                    $scope.Correctdata = [];
