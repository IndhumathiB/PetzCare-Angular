(function () {
    ...
    function ProductInvoiceController($scope, $http, $location, $filter, $rootScope, $timeout) {
        ...
        $http({
            method: 'GET',
            url: 'http://166.62.84.37/PetzCareWS/ProductInvoice.svc/GetAllProductInvoiceList',
            headers: {
        ...
        $scope.getprcinvoice = function (pinvno) {
            ...
            $http({
                ...
                url: 'http://166.62.84.37/PetzCareWS/ProductInvoice.svc/GetProductInvoiceReport',
                headers: {
                    "Content-Type": 'application/json',
                }
            }).success(function (response) {                
        ...
        $scope.newProductinvce = function () {
            ...
            if (!$scope.ProductInvoiceForm.$invalid && !$scope.ProdtInvoiceform.$invalid) {
                $http({
                    ...
                    url: 'http://166.62.84.37/PetzCareWS/ProductInvoice.svc/AddProductInvoice',
                    headers: {
                        "Content-Type": 'application/json',
                    }
                }).success(function (response) {
