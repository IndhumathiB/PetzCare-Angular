(function () {
    ...
    function ManageUsersController($scope, $http, $location,$filter) {
        ...
        $scope.employees = [];
       setTimeout(function () {
        $http.get("http://166.62.84.37/PetzCareWS/Employee.svc/GetAllEmployees")
   ...
   function predicatByDes(prop) {
    return function (a, b) {
        ...
        $scope.employeefltr = function (idno) {
            ...
            $http.post("http://166.62.84.37/PetzCareWS/Employee.svc/GetEmployeeById", id1).success(function (response) {              
        ...
        $scope.empdelete = function (emid,comid,ind) {
            ...
            if (Delete == true) {
            $http.post("http://166.62.84.37/PetzCareWS/Employee.svc/DeleteEmployee", $scope.DeltData).success(function (response) {
