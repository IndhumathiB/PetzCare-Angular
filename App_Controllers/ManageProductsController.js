(function () {
    ...
    function ManageProductsController($scope, $http, $location, $rootScope, $filter, $timeout) {
        ...
        $http({
            method: 'GET',
            url: 'http://166.62.84.37/PetzCareWS/Product.svc/GetAllProducts',
            headers: {
        ...
        $scope.Vaalues = [10, 25, 50];
            ...
            $scope.pageCount = function () {
                ...
                if ($scope.findproduct) {
                    ...
                    $scope.ProductsLists = filtereddata;
                }
        ...
        $scope.CompanyFilter = function (productID) {
            ...
            $http({
                ...
                url: 'http://166.62.84.37/PetzCareWS/Product.svc/GetProductById',
                headers: {
                    "Content-Type": 'application/json',
                }
                ...
                $scope.uPbatchno = response[0].batch_no;             
                $rootScope.uPpronotes = response[0].notes;
                $scope.uPproducid = response[0].product_code;
                ...
                alert($scope.uPbatchno);
                alert($scope.uPproducid);
           ...
           r = new FileReader();
            ...
            if (!$scope.NewManageProductsForm.$invalid) {
                $http({
                    method: 'POST',
                    data: $scope.datas,
                    url: 'http://166.62.84.37/PetzCareWS/Product.svc/AddProduct',
                    headers: {
                        "Content-Type": 'application/json',
                    }
                }).success(function (response) {
        ...
        $scope.UpdateProduct = function () {
            ...
            $scope.producid22 = $scope.uPproducid;
            $scope.batchno22 = $scope.uPbatchno;
            ...
            if (!$scope.ManageProductForm.$invalid) {
                $http({
                    method: 'POST',
                    data: $scope.datas,
                    url: 'http://166.62.84.37/PetzCareWS/Product.svc/UpdateProduct',
                    headers: {
                        "Content-Type": 'application/json',
                    }
                }).success(function (response) {
        ...
        $scope.productsdelete = function (proid, Prindexvalue) {
            ...
            if (Delete == true) {
            $http.post("http://166.62.84.37/PetzCareWS/Product.svc/DeleteProduct", $scope.DeltData).success(function (response) {
                if (response == true) {
                    $scope.ProductDatas();
