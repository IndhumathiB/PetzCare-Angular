    ...
    function ManageCustomerController($scope, $http, $location, $filter, $timeout) {
        ...
        $scope.custmrfltr = function (idno,communiid) {
            ...
            $http({
                method: 'POST',
                data: id1,
                url: 'http://166.62.84.37/PetzCareWSQA/Customer.svc/GetCustomerById',
                headers: {
                    "Content-Type": 'application/json',
                }
            }).success(function (response) {
        ...
        $scope.petimage = function (petimgids) {
            ...
            $http({
                method: 'POST',
                data: petimgid,
                url: 'http://166.62.84.37/PetzCareWSQA/Pets.svc/GetPhotosByPets',
                headers: {
                    "Content-Type": 'application/json',
                }
            }).success(function (response) {
        ...
        $scope.petsnew = function (idno) {
            $scope.petadd = function () {
                ...
                $http({
                    method: 'POST',
                    data: $scope.data1,
                    url: 'http://166.62.84.37/PetzCareWSQA/Pets.svc/AddPet',
                    headers: {
                        "Content-Type": 'application/json',
                    }
                }).success(function (response) {
                    ...
                    if (response) {
                        ...
                        $http({
                            method: 'POST',
                            data: photos,
                            url: 'http://166.62.84.37/PetzCareWSQA/Pets.svc/AddPhoto',
                            headers: {
                                "Content-Type": 'application/json',
                        }
                        }).success(function (response) {
        ...
        $scope.CUSTOMERdelete = function (custId1, comid,inDeXvalue) {
                ...
                $http.post("http://166.62.84.37/PetzCareWSQA/Customer.svc/DeleteCustomer", $scope.DeltData).success(function (response) {
        ...
        $scope.custadd = function () {
            ...
            if (!$scope.customerForm.$invalid) {
                $http({
                    method: 'POST',
                    data: $scope.data,
                    url: 'http://166.62.84.37/PetzCareWSQA/Customer.svc/AddCustomer',
                    headers: {
                        "Content-Type": 'application/json',
                    }
                }).success(function (response) {
        ...
        $scope.UpdateCustomer = function () {
            ...
            $http({
                method: 'POST',
                data: $scope.data,
                url: 'http://166.62.84.37/PetzCareWSQA/Customer.svc/UpdateCustomer',
                headers: {
                    "Content-Type": 'application/json',
                }
            }).success(function (response) {
