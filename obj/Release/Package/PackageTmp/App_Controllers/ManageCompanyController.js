    ...
    function ManageCompanyController($scope, $http, $location, $rootScope, $filter, $timeout) {
        ...
        $scope.GetCompany = function (companyid,communiID) {
            ...
            $http({
                ...
                url: 'http://166.62.84.37/PetzCareWSQA/Company.svc/GetCompanyById',
                headers: {
                    "Content-Type": 'application/json',
                }
        ...
        $scope.Editcompany = function (compan) {
            ...
            $http({
                ...
                url: 'http://166.62.84.37/PetzCareWSQA/Communications.svc/GetCommunicationsByEntityId',
                headers: {
                    "Content-Type": 'application/json',
                }
            }).success(function (response) {
    ...
    function GetCity1(ldIdCity) {
      ...
      if (!$scope.companyForm.$invalid) {
          $http({
              method: 'POST',
              data: $scope.data,
              url: 'http://166.62.84.37/PetzCareWSQA/Company.svc/AddCompany',
              headers: {
                  "Content-Type": 'application/json',
              }
          }).success(function (response) {
        ...
        $scope.UpdateCompany = function () {
            ...
            if (!$scope.companyUpdateForm.$invalid) {
                $http({
                    method: 'POST',
                    data: $scope.data,
                    url: 'http://166.62.84.37/PetzCareWSQA/Company.svc/UpdateCompany',
                    headers: {
                        "Content-Type": 'application/json',
                    }
                }).success(function (response) {
        ...
        $scope.companydelete = function (cmpnyid,commnid,compnyindex) {          
            ...
            if (Delete == true) {
                $http.post("http://166.62.84.37/PetzCareWSQA/Company.svc/DeleteCompany", $scope.DeltData).success(function (response) {
